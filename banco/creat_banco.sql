-- Excluir as tabelas caso elas já existam
...
CREATE TABLE MONI_ATENDIMENTO(
    ID_ATENDIMENTO integer PRIMARY KEY auto_increment,
    ID_DISCIPLINA integer not null,
    MATRICULA VARCHAR(8) not null,
    DATA_REGISTO datetime not null,
    COMENTARIO varchar(100) DEFAULT null,
    CONSTRAINT fk_ATENDIMENTO_DISCIPLINA FOREIGN KEY (ID_DISCIPLINA) REFERENCES MONI_DISCIPLINA(ID_DISCIPLINA)
)